...
public void R_repaint(){
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                ...
                Pintar.pintarLinea(VentanaPrincipal.PrincipalWindow.getGraphics(),arboles.getCordeX(j),arboles.getCordeY(j), arboles.getCordeX(k), arboles.getCordeY(k),arboles.getmCoeficiente(j, k));
            }
        }
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(VentanaPrincipal.PrincipalWindow.getGraphics(), arboles.getCordeX(j),arboles.getCordeY(j),String.valueOf(arboles.getNombre(j)));
 ...
 Pintar pintar ;
    ...
    private void initComponents() {
        ...
        jPanel1.add(n2);
        n2.setBounds(100, 60, 30, 27);

        jLabel1.setText("Digite el Nodo 1");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 30, 110, 17);
        ...
        jButton1.setBounds(30, 110, 90, 29);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                n1.setText(null);
                n2.setText(null);
                VentanaPrincipal.PrincipalWindow.paint(VentanaPrincipal.PrincipalWindow.getGraphics());
