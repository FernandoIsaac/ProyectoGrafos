...
public class VentanaArista extends javax.swing.JFrame implements Serializable{
         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
            ...
            JOptionPane.showMessageDialog(null,"Error.. Nodos No validos "); 
             ...
             n2.setText(null);
             tm.setText(null);
            Pintar.pintarLinea(VentanaPrincipal.PrincipalWindow.getGraphics(),arboles.getCordeX(x), arboles.getCordeY(x), arboles.getCordeX(y), arboles.getCordeY(y), ta);
             System.out.println("ESTE ES EL BOTON QUE HACE QUE SE HAGA LA LINEA VERDE");
         } 
         }
